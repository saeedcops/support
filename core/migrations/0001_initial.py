# Generated by Django 3.2.6 on 2021-12-26 17:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to=core.models.user_image_path, verbose_name='Image')),
                ('language', models.CharField(choices=[('ar', 'Arabic'), ('en', 'English')], default='ar', max_length=10, verbose_name='Language')),
                ('department', models.CharField(blank=True, max_length=15, null=True, verbose_name='Department')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('open_date', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Open Date')),
                ('closed_date', models.DateTimeField(blank=True, null=True, verbose_name='Closed Date')),
                ('description', models.TextField(verbose_name='Description')),
                ('admin', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='admin', to=settings.AUTH_USER_MODEL, verbose_name='Admin')),
                ...
                ('messages', models.ManyToManyField(to='core.Message', verbose_name='Messages')),
                ('pc', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.pc', verbose_name='PC')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='userticket', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
                'verbose_name': 'Ticket',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default=django.utils.timezone.now, verbose_name='Date')),
                ('file_scan', models.FileField(blank=True, null=True, upload_to=core.models.user_directory_path, verbose_name='File')),
                ('branch', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='branchrequest', to='core.branch', verbose_name='Branch')),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='userrequest', to='core.category', verbose_name='Category')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='userrequest', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
                'ordering': ['-date'],
            },
